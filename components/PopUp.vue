<template>
    <div class="flex justify-center items-center">
        <div class="`max-w-125 w-[95%] mx-auto rounded-md space-y-3 bg-slate-100 relative p-10">
            <p @click="deleteModalSwitch = false" class="text-2xl font-mono absolute top-2 right-2 text-black hover:text-black/70 hover:font-bold cursor-pointer">X</p>
            ...
            <div class="flex gap-4 justify-center mt-4">
                ...
                <button @click="deleteModalSwitch = false" class="py-1 px-10 rounded-md ring-1 ring-green-600 hover:bg-green-400 transition-colors">NO</button>
            </div>
        </div>
    </div>
</template>
...
const { deleteModalSwitch } = storeToRefs(accountStore)
